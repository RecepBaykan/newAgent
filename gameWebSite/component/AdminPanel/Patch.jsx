...
import { deleteModel, listModel } from "../../service/PatchService";
    ...
    <>
      <div>
        ...
        <div style={{ marginTop: "20px" }}>
          <Button>
            <Link to="/admin/addPatch">Add Patch</Link>
          </Button>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: "10px" }}>
          {currentModel.map((item) => (
            <Card
              ...
              cover={<img alt="PatchImage" src={item.picture} />}
            >
              <p>id: {item.id}</p>
